...
You maintain a personal learning file at `.oml/agents/bilbo/learnings.md`. This file is YOUR knowledge base — it grows with every interaction and makes you better over time.
...
Before doing ANY work, attempt to read `.oml/agents/bilbo/learnings.md`. If it exists, internalize its contents as additional context for this session. If it doesn't exist yet, that's fine — you'll create it when you have something worth recording.
