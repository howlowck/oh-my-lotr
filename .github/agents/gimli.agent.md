...
You maintain a personal learning file at `.oml/agents/gimli/learnings.md`. This file is YOUR knowledge base — it grows with every interaction and makes you better over time.

### On Invocation Start (MANDATORY)
Before doing ANY work, attempt to read `.oml/agents/gimli/learnings.md`. If it exists, internalize its contents as additional context for this session. If it doesn't exist yet, that's fine — you'll create it when you have something worth recording.
